...
type Dialect interface {
	ListCurrent(ctx context.Context, prefix string, limit int64, includeDeleted bool) ([]*messagestructures.QueryGenericRow, error)
	List(ctx context.Context, prefix, startKey string, limit, revision int64, includeDeleted bool) ([]*messagestructures.QueryGenericRow, error)
	Count(ctx context.Context, prefix string) (int64, int64, error)
	CurrentRevision(ctx context.Context) (int64, error)
	After(ctx context.Context, prefix string, rev, limit int64) ([]*messagestructures.QueryGenericRow, error)
